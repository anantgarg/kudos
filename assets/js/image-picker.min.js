...
(function() {
  ...
  ImagePickerOption = (function() {
    ...
    ImagePickerOption.prototype.create_node = function() {
      var image, thumbnail;
      this.node = jQuery("<li class='social_image_base2' />");
      image = jQuery("<span class='image_picker_image social_image fa-3x fa fa-"+this.option.data("img-src")+"'/>");
      image.attr("src", this.option.data("img-src"));
	  image.attr("title", this.option.data("img-label"));
...
//	  this.node.append('<span class="social_image_superimpose2 '+this.option.data("img-type")+' fa fa-'+this.option.data("img-type")+'-square"></span>');
