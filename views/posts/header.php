	...
	<div class="row">
		<div class="col-sm-3">
			<div class="list-group">
				...
				<a class="list-group-item <?php if (!empty($account['current'])):?>active<?php endif;?>" href="<?php echo BASE_URL;?>posts/live/<?php echo $account['id'];?>"><?php echo $account['name'];?> (<?php echo ucwords($account['type']);?>)</a>
